...
for (let i=0; i<4; i++){
let pick = Math.round(Math.random()*193);
let country= [
    countryList[pick].country,
    countryList[pick].iso
]
...
// start function that calls country picker
// & checks if all answers follow the criteria:
// Not been a past answer, not a duplicate.
// if it passes, otherwise draw new.
